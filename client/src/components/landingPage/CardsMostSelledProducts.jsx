...
function CardsMostSelledProducts({ name, image, price, description, category, stock, id, addProductCarrito, addFavorite, removeFavorite }) {
...
export default connect(null, { addProductCarrito, addFavorite, removeFavorite })(CardsMostSelledProducts)