...
function ProductCard({ name, image, price, description, category, stock, id, addProductCarrito }) {
    ...
    return (
        <div id={id} className={style.card}>
            <Link className={style.linkTo} to={`/detail/${id}`}><img src={image} className={style.cardImg} alt='Imagen producto' /></Link>
            ...
            <div className={style.footer}>
                ...
                <button className={style.btnDetail}>Detalles</button>
...
export default connect(null, { addProductCarrito })(ProductCard)